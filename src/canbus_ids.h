...
typedef enum {
  ...
  CANBUS_ID_FSM_STATE,
  CANBUS_ID_FSM_MODE,
  CANBUS_ID_DEVICE_STATUS,
  CANBUS_ID_COMBUSTION_FAN_PERCENT,
  CANBUS_ID_GLOW_PLUG_PERCENT,
  CANBUS_ID_BURN_POWER,
  CANBUS_ID_CIRCULATION_PUMP_PERCENT,
  CANBUS_ID_FLAME_DETECTOR_ENABLED,
  CANBUS_ID_FUEL_PUMP_FREQUENCY,
  ...
  CANBUS_ID_FLOW_EXTERNAL_INGRESS,
  CANBUS_ID_FLOW_EXTERNAL_EGRESS,
  CANBUS_ID_FLOW_HEAT_EXCHANGE_COOLANT_INGRESS,
  CANBUS_ID_FLOW_HEAT_EXCHANGE_COOLANT_EGRESS,
  CANBUS_ID_FLOW_HEAT_EXCHANGE_EXTERNAL_INGRESS,
  CANBUS_ID_FLOW_HEAT_EXCHANGE_EXTERNAL_EGRESS,
  CANBUS_ID_FLOW_HEATER_CORE_INGRESS,
  CANBUS_ID_FLOW_HEATER_CORE_EGRESS,
  CANBUS_ID_FLOW_ENGINE_EGRESS,
  CANBUS_ID_FLOW_WEBASTO_INGRESS,
  CANBUS_ID_FLOW_PELTIER_INGRESS,

  CANBUS_ID_COOLANT_TEMP_EXTERNAL_INGRESS,
  CANBUS_ID_COOLANT_TEMP_EXTERNAL_EGRESS,
  CANBUS_ID_COOLANT_TEMP_HEAT_EXCHANGE_COOLANT_INGRESS,
  CANBUS_ID_COOLANT_TEMP_HEAT_EXCHANGE_COOLANT_EGRESS,
  CANBUS_ID_COOLANT_TEMP_HEAT_EXCHANGE_EXTERNAL_INGRESS,
  CANBUS_ID_COOLANT_TEMP_HEAT_EXCHANGE_EXTERNAL_EGRESS,
  CANBUS_ID_COOLANT_TEMP_HEATER_CORE_INGRESS,
  CANBUS_ID_COOLANT_TEMP_HEATER_CORE_EGRESS,
  CANBUS_ID_COOLANT_TEMP_ENGINE_EGRESS,
  CANBUS_ID_COOLANT_TEMP_WEBASTO_INGRESS,
  CANBUS_ID_COOLANT_TEMP_PELTIER_INGRESS,
  CANBUS_ID_COOLANT_TEMP_PELTIER_EGRESS,
  CANBUS_ID_COOLANT_TEMP_WATER_COOLER,
